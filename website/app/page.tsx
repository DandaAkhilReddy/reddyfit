          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8">
                Track your fitness with Whoop, Apple HealthKit, or manual entry.
                Get AI-powered insights and join a community of elite athletes.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-400">
              Multi-source tracking, AI insights, and community-driven innovation
            </p>
          </motion.div>
